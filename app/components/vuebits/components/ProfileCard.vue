        ...
        <section ref="cardRef" class="pc-card">
            <div class="pc-inside">
                ...
                <div class="pc-content pc-avatar-content">
                    <img class="cavatar mix-blend-luminosity" :src="avatarUrl" :alt="`${name || 'User'} avatar`" loading="lazy" @error="handleAvatarError" />

                    <div v-if="showUserInfo" class="pc-user-info">
                        <div class="pc-user-details">
                            <div class="pc-mini-avatar">
                                <img :src="miniAvatarUrl || avatarUrl" :alt="`${name || 'User'} mini avatar`" loading="lazy" @error="handleMiniAvatarError" />
                            </div>

                            <div class="pc-user-text">
                                <div class="pc-handle" :style="{ color: textColor }">@ {{ handle }}</div>

                                <div class="pc-status" :style="{ color: textColor }">{{ status }}</div>
                            </div>
                        </div>
                ...
                <div class="pc-content mix-blend-luminosity">
