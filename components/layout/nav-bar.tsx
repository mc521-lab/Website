...
import { ExperimentalFlagsDialog } from "@/components/experimental/toggle-dialog";
...
export function Navbar() {
    ...
    return (
        <header
            className={cn(
                useExperimental && showExperimental ? "bg-black/70" : "bg-black/30",
            ...
            <TooltipProvider>
                <div className="hidden items-center gap-2 lg:flex">
                    {showExperimental && <ExperimentalFlagsDialog />}
                    {isFeedbackRoute && (
